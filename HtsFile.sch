...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DocumentReference">
      <sch:assert test="count(f:extension[@url = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/htsfile-genome-assembly']) &gt;= 1">extension with URL = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/htsfile-genome-assembly': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/htsfile-genome-assembly']) &lt;= 1">extension with URL = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/htsfile-genome-assembly': maximum cardinality of 'extension' is 1</sch:assert>
