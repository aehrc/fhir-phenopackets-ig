...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/Severity']) &lt;= 1">extension with URL = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/Severity': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/Onset']) &lt;= 1">extension with URL = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/Onset': maximum cardinality of 'extension' is 1</sch:assert>
