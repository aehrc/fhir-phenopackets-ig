...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile Family member history for genetics analysis
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:FamilyMemberHistory">
      <sch:assert test="count(f:extension[@url = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/pedigree-node-affected-status']) &gt;= 1">extension with URL = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/pedigree-node-affected-status': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/pedigree-node-affected-status']) &lt;= 1">extension with URL = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/pedigree-node-affected-status': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/pedigree-node-family-identifier']) &gt;= 1">extension with URL = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/pedigree-node-family-identifier': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/pedigree-node-family-identifier']) &lt;= 1">extension with URL = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/pedigree-node-family-identifier': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/pedigree-node-individual']) &lt;= 1">extension with URL = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/pedigree-node-individual': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:sex) &gt;= 1">sex: minimum cardinality of 'sex' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
