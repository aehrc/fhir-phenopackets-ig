...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/CodedOnset']) &lt;= 1">extension with URL = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/CodedOnset': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/TumorStage']) &lt;= 1">extension with URL = 'http://ga4gh.org/fhir/phenopackets/StructureDefinition/TumorStage': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
